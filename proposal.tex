...
\csname title\endcsname{\textbf{Detecting Reseller Bots in Limited Clothing Drops Using Risk Scoring and Navigation Patterns}}
...
\csname tikzstyle\endcsname{box}=[draw, rounded corners, align=center, minimum width=3.7cm, minimum height=0.9cm]
...
% Optional: Replace these with actual UI sketches you add to your repo.
\begin{figure}[h]
\centering
\fbox{\parbox{0.9\linewidth}{\centering Placeholder for UI sketch 1 (e.g., Product + Cart + Checkout screens).}}
\caption{UI sketch placeholder 1 (replace with an image file in your repo).}
\end{figure}

\begin{figure}[h]
\centering
\fbox{\parbox{0.9\linewidth}{\centering Placeholder for UI sketch 2 (e.g., Risk score dashboard / admin view).}}
\caption{UI sketch placeholder 2 (replace with an image file in your repo).}
\end{figure}

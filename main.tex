...
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_1_risk_score_distribution.png}
	\caption{Risk score distribution by session type.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_2_request_rate_distribution.png}
...
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_3_risk_score_over_runs.png}
	\caption{Risk score across experiment runs.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_4_risk_band_counts.png}
...
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_5_mitigation_actions.png}
	\caption{Mitigation actions by session type.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_6_normalized_feature_comparison.png}
...
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_7_risk_score_vs_request_rate.png}
	\caption{Risk score versus request rate.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\linewidth}
	\centering
	\includegraphics[width=\linewidth]{figures/figure_8_detection_threshold_tradeoff.png}
...
>>>>>>> a8e787f (revise final paper framing title and abstract)
